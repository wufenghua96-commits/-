...
const projects = [
  ...
  { id:'echo-character', index:'03', title:'OTHER PROJECTS', cn:'其他项目', tags:['综合设计','持续更新','2024—至今'], tone:'violet', description:'收录平面、IP、界面、AIGC 与动态影像等多方向的设计实践和视觉实验。', metrics:['多类型项目','跨媒介实践','持续更新中'] },
]
  ...
  useLayoutEffect(()=>{
    ...
    const frame=requestAnimationFrame(()=>{
      context=gsap.context(()=>{
        ...
        if(route==='project/flux-interface'){
